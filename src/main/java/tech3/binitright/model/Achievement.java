...
public final class Achievement {
    ...
    public Achievement(final String name, final String description, 
                       final String criteria, final String badgeIconUrl) {
        this.name = name;
    ...
    public void setBadgeIconUrl(final String badgeIconUrl) {
        this.badgeIconUrl = badgeIconUrl;
    }
    ...
    public void setUserAchievement(final List<UserAchievement> userAchievement) {
