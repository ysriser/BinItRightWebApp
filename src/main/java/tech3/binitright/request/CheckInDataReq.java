...
public class CheckInDataReq {	
	...
	public String toString() {
		return "CheckInDataReq [userId=" + userId + ", binId=" + binId + ", wasteCategory=" + wasteCategory
				+ ", checkInTime=" + checkInTime + ", status=" + status + ", quantity=" + quantity + ", rewardPoints="
				+ rewardPoints + ", duration=" + duration + "]";
	}
