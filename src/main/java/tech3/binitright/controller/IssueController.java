...
public final class IssueController {
    ...
    public String viewIssues(final Model model) {
        ...
        model.addAttribute("newCount", issueService.countByStatus(IssueStatus.NEW));
        model.addAttribute("inProgressCount", issueService.countByStatus(IssueStatus.INUPROGRESS));
    ...
    public String markInProgress(@PathVariable final Long id, final Authentication authentication) {
    ...
    public String resolveIssue(@PathVariable final Long id, final Authentication authentication) {
        final String username = authentication.getName();
        final Admin admin = adminService.getSingleAdminByUsername(username);
